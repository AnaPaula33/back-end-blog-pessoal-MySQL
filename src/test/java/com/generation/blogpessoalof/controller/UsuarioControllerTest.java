package com.generation.blogpessoalof.controller;
...
import com.generation.blogpessoalof.model.Usuario;
import com.generation.blogpessoalof.repository.UsuarioRepository;
import com.generation.blogpessoalof.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antunes",
				"https://i.imgur.com/FETvs20.jpg", "paulo_antunes@email.com.br", "13465279"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, "Juliana Andrews",
				"http://i.imgur.com/yDRVeK7.jpg", "juliana_andrew@email.com.br", "juliana123"));

		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), "Juliana Andrews Ramos",
				"http://i.imgur.com/T12NIp9.jpg", "juliana_ramos@email.com.br", "juliana123");
	...
	@Test
	@Order(4)
	@DisplayName("Listas todos os Usuários")
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Ricardo Marques", "https://i.imgur.com/Sk5SjWE.jpg",
				"ricardo_marques@email.com.br", "ricardo122"));
